                ...
                <div className=" relative  ">
                    ...
                    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl">
                        ...
                        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-stone-400/20">
                            <div className="flex justify-center items-center hover:rounded-lg mx-auto hover:bg-[#e3bc9a]/40 hover:text-gray-200 w-[40%] gap-2" >
                            ...
                            <form onSubmit={handlesubmit}>
                                ...
                                <div className="mt-6">
                                    <input type="submit" value="Login with Email" className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pink rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50" />
