            ...
            <div className=" relative  ">
                ...
                <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl">
                    ...
                    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-stone-600/30">
                        ...
                        <button className="flex items-center justify-center gap-3 mt-4 text-white transition-colors duration-300 transform border rounded-lg bg-zinc-800/50 border-gray-700 dark:text-gray-200 hover:bg-gray-50 hover:text-gray-700 dark:hover:bg-gray-600 w-full">
